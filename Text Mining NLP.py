...
for i in range(1,21):
  ip=[]  
  url="https://www.snapdeal.com/product/reliance-4g-black-data-cards/618575312815/reviews?page="+str(i)
  response = requests.get(url)
  # creating soup object to iterate over the extracted content
  soup = bs(response.content,"html.parser")
  reviews = soup.find_all("div", attrs={"class","user-review"})
  ...
  sreviews= sreviews + ip  

# writng reviews in a text file 
with open("snapdeal-jio.txt","w",encoding='utf8') as output:
    output.write(str(sreviews))
	

# Joinining all the reviews into single paragraph 
ip_rev_string = " ".join(sreviews)
...
stop_words.extend(["jio","snapdeal","like","delivery","device","battery","product","good","day","price"])
...
customised_words = ['sexy','cute','jio','snapdeal','jiofi','hot','received','delivery'] 
